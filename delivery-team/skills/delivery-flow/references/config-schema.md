...
|-----|------|----------|---------|-------------|-----------|-------------|
| `config_version` | string | yes | "2.3" | semver string | auto | delivery-flow (migration check) |
...
| `presentation.default_format` | string | no | "structured-markdown" | structured-markdown, marp, paste-ready | defaults | presentation (output format) |
