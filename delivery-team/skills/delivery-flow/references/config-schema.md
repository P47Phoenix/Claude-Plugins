...
|-----|------|----------|---------|-------------|-----------|-------------|
| `config_version` | string | yes | "2.7" | semver string | auto | delivery-flow (migration check) |
| `routing.force_type` | string/null | no | null | GREENFIELD, FEATURE, BUG_FIX, GAME_DEV+GREENFIELD, GAME_DEV+FEATURE, GAME_DEV+BUG_FIX, SPIKE, DOCS_ONLY, or null | defaults | delivery-flow (optional opt-in override for Phase 1 detection — Phase 1 still runs and is logged, but routing uses the pin) |
