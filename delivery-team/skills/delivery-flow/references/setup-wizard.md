...
4. Write `.delivery/config.md` (the config generated above)
5. Write `.delivery/README.md` with the following content:
...
- `memory/` -- Self-learning memory from past pipeline runs
- `README.md` -- This file
