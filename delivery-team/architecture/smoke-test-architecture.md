...
```json
{
  ...
  "model_usage": [
    {"model": "claude-opus-fixture", "dispatches": 3, "input_tokens": 8000, "output_tokens": 4200},
    {"model": "claude-sonnet-fixture", "dispatches": 5, "input_tokens": 4345, "output_tokens": 2589}
  ],
  "pipeline": {
    "stages_completed": 7,
    "stories_completed": 1,
