<!-- STALE-WAVE-N-1 (W3-17 banner): this artifact carries marker `run-2026-05-13-tk5` but the current pipeline is `run-2026-09-18-pr88`. Producer/validator: confirm relevance before re-using. -->
