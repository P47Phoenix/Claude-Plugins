...
- **DEFECT-008** (open, P3 non-blocking, run-2026-09-18-pr88) — manifest.yml line 49 invalid YAML, pre-existing on main.
- **DEFECT-009** (open, P4 non-blocking, run-2026-09-18-pr88) — stale SKILL.md line anchor in sub-agent-dispatch.md:51 and stale cache-prefix-hash.txt; pre-existing.
